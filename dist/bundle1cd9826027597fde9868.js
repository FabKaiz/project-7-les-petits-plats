...
var CardComponents = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(CardComponents, [{
    ...
    value: function createIngredientsList(ingredient) {
      ...
      var qty = "".concat(quantity ? quantity : '', " ").concat(unit ? unit : '').trim();
      var ingredientsLi = "<li><strong>".concat(ingre, " ").concat(qty ? ":" : "", " </strong> ").concat(qty, "</li>");
  ...
  _createClass(FiltersComponents, [{
    ...
    value: function createFiltersArray(filterName) {
      ...
      this.$cards.forEach(function (card) {
        _this2.cardFilterTypes = card.dataset[filterName].toLowerCase().split(',');
        _this2.cardFilterTypes.forEach(function (filterType) {
          _this2.isFilterTypePresent = _this2.filtersArray.includes(filterType);
          _this2.isTagPresent = _this2.tags.some(function (tag) {
            return tag.dataset.tagName.toLowerCase() === filterType;
          });
          if (!_this2.isFilterTypePresent && !_this2.isTagPresent) {
    ...
    key: "searchFilters",
    value: function searchFilters(filterName, customSelect) {
      var _this3 = this;
    ...
    value: function closeFilters(customSelect) {
      ...
      setTimeout(function () {
        customSelect.addEventListener('click', function () {
          return _this5.openFilters(customSelect);
        }, {
          once: true
        });
      }, 10);
    ...
    value: function openFilters(customSelect) {
      ...
      this.customSelectInput.addEventListener('keyup', function () {
        return _this6.searchFilters(_this6.customSelectName, customSelect);
      });
      ...
      this.closeFiltersBtn.addEventListener('click', function () {
        return _this6.closeFilters(customSelect);
      }, {
        once: true
      });
    ...
    key: "createFilterItemsListeners",
    value: function createFilterItemsListeners(customSelect) {
      var _this7 = this;
    ...
    key: "convertCustomSelectToInput",
    value: function convertCustomSelectToInput() {
      this.customSelectInput.focus();
      this.customSelectInput.value = '';
      this.customSelectInput.type = 'search';
      this.customSelectInput.placeholder = "Rechercher un ".concat(this.translateFilters(this.customSelectName));
    }
  }, {
    ...
    value: function init() {
      ...
      this.filtersTitle.forEach(function (key) {
        return _this8.innerHTML += _this8.createFiltersHTML(key);
      });
    }
  }]);
    ...
    * */
    function performSearch2() {
      ...
      if (this.searchInputValue.length < 3 && !this.tagsArray) {
        var _iterator = _createForOfIteratorHelper(this.recipesArray),
          _step;
        try {
      ...
      var _iterator2 = _createForOfIteratorHelper(this.recipesArray),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _recipe = _step2.value;
          this.isTitleVisible = this.removeDiacritics(_recipe.title).includes(this.searchValue);
          this.areIngredientsVisible = _recipe.ingredients.some(function (ingredient) {
            return _this4.removeDiacritics(ingredient.ingredient).includes(_this4.searchValue);
          });
          this.isDescriptionVisible = this.removeDiacritics(_recipe.description).includes(this.searchValue);
          ...
          _recipe.element.classList.toggle('hide', !this.isVisible);
        }
      ...
      var isNoResult = true;
      var _iterator3 = _createForOfIteratorHelper(this.recipesArray),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var _recipe2 = _step3.value;
          if (!_recipe2.element.classList.contains('hide')) {
            isNoResult = false;
            break;
          }
        }
...
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg clip-path=%27url%28%23clip0_51_0%29%27%3E%3Cpath d=%27M14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.41L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8ZM12 2C6.47 2 2 6.47 2 12C2 17.53 6.47 22 12 22C17.53 22 22 17.53 22 12C22 6.47 17.53 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z%27 fill=%27%23E7E7E7%27/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id=%27clip0_51_0%27%3E%3Crect width=%2724%27 height=%2724%27 fill=%27%23E7E7E7%27/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E%0A */ "data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg clip-path=%27url%28%23clip0_51_0%29%27%3E%3Cpath d=%27M14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.41L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8ZM12 2C6.47 2 2 6.47 2 12C2 17.53 6.47 22 12 22C17.53 22 22 17.53 22 12C22 6.47 17.53 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z%27 fill=%27%23E7E7E7%27/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id=%27clip0_51_0%27%3E%3Crect width=%2724%27 height=%2724%27 fill=%27%23E7E7E7%27/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E%0A"), __webpack_require__.b);
...
/***/ "data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg clip-path=%27url%28%23clip0_51_0%29%27%3E%3Cpath d=%27M14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.41L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8ZM12 2C6.47 2 2 6.47 2 12C2 17.53 6.47 22 12 22C17.53 22 22 17.53 22 12C22 6.47 17.53 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z%27 fill=%27%23E7E7E7%27/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id=%27clip0_51_0%27%3E%3Crect width=%2724%27 height=%2724%27 fill=%27%23E7E7E7%27/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E%0A":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg clip-path=%27url%28%23clip0_51_0%29%27%3E%3Cpath d=%27M14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.41L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8ZM12 2C6.47 2 2 6.47 2 12C2 17.53 6.47 22 12 22C17.53 22 22 17.53 22 12C22 6.47 17.53 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z%27 fill=%27%23E7E7E7%27/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id=%27clip0_51_0%27%3E%3Crect width=%2724%27 height=%2724%27 fill=%27%23E7E7E7%27/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E%0A ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = "data:image/svg+xml,%3Csvg width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg clip-path=%27url%28%23clip0_51_0%29%27%3E%3Cpath d=%27M14.59 8L12 10.59L9.41 8L8 9.41L10.59 12L8 14.59L9.41 16L12 13.41L14.59 16L16 14.59L13.41 12L16 9.41L14.59 8ZM12 2C6.47 2 2 6.47 2 12C2 17.53 6.47 22 12 22C17.53 22 22 17.53 22 12C22 6.47 17.53 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z%27 fill=%27%23E7E7E7%27/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id=%27clip0_51_0%27%3E%3Crect width=%2724%27 height=%2724%27 fill=%27%23E7E7E7%27/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E%0A";
...
/******/ })()
;
//# sourceMappingURL=bundle1cd9826027597fde9868.js.map